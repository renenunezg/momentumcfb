...
class OddsAPIClient:
    ...
    def get_ncaaf_odds(
        ...
        params = {
            ...
            "oddsFormat": "american",
            "dateFormat": "iso",
            "commenceTimeFrom": commence_from.astimezone(timezone.utc).isoformat(),
            "commenceTimeTo": commence_to.astimezone(timezone.utc).isoformat(),
            "includeLinks": "true",
        }
        if self.bookmakers:
        ...
        response = self.session.get(
            f"{ODDS_API_BASE_URL}/sports/{NCAAF_SPORT_KEY}/odds",
            params=params,
            timeout=60,
        )
